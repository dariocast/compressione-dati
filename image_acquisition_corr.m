% eval_corr is a boolean parameter, if true it evaluates also correlation between sequencial stripes 
function  [Y, Phi, corr_vector] = image_acquisition_corr (X,s,m, eval_corr)
